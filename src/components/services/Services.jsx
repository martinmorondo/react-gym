...
return ( 
    <main id="servicios" className="bg-gray-900 py-10"> <div className="container mx-auto px-4"> <h1 className="mb-8 text-center text-3xl font-bold text-white md:text-4xl">
    Servicios </h1>
